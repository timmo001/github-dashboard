...
function Repository({ clientId }: RepositoryProps): ReactElement {
  ...
  return (
    <Layout classes={classes} title="Repository" description="GitHub Repository">
      <Grid
...
export const getStaticProps: GetStaticProps<RepositoryProps> = async () => {
  return {
    props: {
